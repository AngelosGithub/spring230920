...
import com.example.spring230920.domain.MyDto42;
import com.example.spring230920.domain.MyDto43;
import com.example.spring230920.domain.MyDto44;
...
public class Controller37 {
    ...
    /*
     ...
     직렬화(serialize)
     js object -> jason text

     파싱(parse)
     jason text -> js(java) object
     */
    @PostMapping("sub1")
     ...
     */
    @PostMapping("sub5")
    public void method4(@RequestBody MyDto43 dto) {
