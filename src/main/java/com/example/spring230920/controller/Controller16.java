...
public class Controller16 {
    ...
    public void method4(Model model, HttpSession session) {
        Object modelAttr1 = model.addAttribute("modelAttr1");
    ...
    // sub14로 보냈을 때 sub15로 보내고 sub15 요청할 때 foodList 라는 attribute를 꺼낼수 있게...
    @GetMapping("sub14")
    public String method14(RedirectAttributes rttr) {
        rttr.addFlashAttribute("foodList", List.of("pizza", "burger"));
